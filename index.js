(() => {
  ...
  function restartGame() {
    init(); // Call the init function to reset the game state
    gameOverlayer.style.display = "none"; // Hide the game over overlay
    canvas.classList.remove("game-over"); // Remove the game-over class from the canvas
